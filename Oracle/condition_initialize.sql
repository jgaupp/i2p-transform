/** condition_intialize - create the condition table, sourcefact2 table and condtion procedure.
*/
...
/
insert into cdm_status (status, last_update) select 'condition_initialize', sysdate from dual
/
select 1 from cdm_status where status = 'condition_initialize'
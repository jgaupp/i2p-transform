...
class Script(ScriptMixin, enum.Enum):
    ...
    [
        ...
        death_initialize,
        death_cause,
        demographic_finalize,
        demographic_group,
        demographic_initialize,
        diagnosis_finalize,
        diagnosis_group,
        diagnosis_initialize,
        dispensing_finalize,
        dispensing_group,
        dispensing_initialize,
        encounter_finalize,
        encounter_group,
        ...
        harvest,
        lab_result_cm_finalize,
        lab_result_cm_group,
        lab_result_cm_initialize,
        med_admin_finalize,
        med_admin_group,
        med_admin_initialize,
        obs_clin,
        obs_gen,
        ...
        pcornet_loader,
        pcornet_trial,
        prescribing_finalize,
        prescribing_group,
        prescribing_initialize,
        pro_cm,
        procedures_finalize,
        procedures_group,
        procedures_initialize,
        provider_finalize,
        provider_group,
        provider_initialize,
        vital_finalize,
        ...
        for fname in [
                ...
                'death_intialize.sql',
                'death_cause.sql',
                'demographic_finalize.sql',
                'demographic_group.sql',
                'demographic_initialize.sql',
                'diagnosis_finalize.sql',
                'diagnosis_group.sql',
                'diagnosis_initialize.sql',
                'dispensing_finalize.sql',
                'dispensing_group.sql',
                'dispensing_initialize.sql',
                'encounter_finalize.sql',
                'encounter_group.sql',
                'encounter_initialize.sql',
                'enrollment_finalize.sql',
                'enrollment_group.sql',
                'enrollment_initialize.sql',
                'harvest.sql',
                'lab_result_cm_finalize.sql',
                'lab_result_cm_group.sql',
                'lab_result_cm_initialize.sql',
                'med_admin_finalize.sql',
                'med_admin_group.sql',
                'med_admin_initialize.sql',
                'obs_clin.sql',
                'obs_gen.sql',
                ...
                'pcornet_loader.sql',
                'pcornet_trial.sql',
                'prescribing_finalize.sql',
                'prescribing_group.sql',
                'prescribing_initialize.sql',
                'pro_cm.sql',
                'procedures_finalize.sql',
                'procedures_group.sql',
                'procedures_initialize.sql',
                'provider_finalize.sql',
                'provider_group.sql',
                'provider_initialize.sql',
                'vital_finalize.sql',
                'vital_group.sql',
                'vital_initialize.sql'
        ]
    ]
